...
namespace RiaServicesMailMerge.Web
{
    ...
    [EnableClientAccess()]
    public class DomainService1 : LinqToEntitiesDomainService<AdventureWorksEntities>
    {
        ...
        public IQueryable<vEmployee> GetVEmployees()
        {
            return this.ObjectContext.vEmployees;
        }
    }
}
